...
PERSONAL | Outside work Shan is a geography nerd and keen traveller, which is what inspired Visa Atlas. He's someone who likes building Lego and turning messy problems into clean systems. Quick to reply, easy to work with.
...
export function localAnswer(q: string): string {
  ...
  if (has("personal", "hobby", "hobbies", "interest", "outside", "lego", "geograph", "who is", "like"))
    return "Outside work, Shan is a geography nerd and keen traveller (it’s genuinely why he built **Visa Atlas**), and likes building Lego. Same instinct in all of it: take a messy pile of parts and turn it into something that clicks together.";
