...
export const timeline: TimelineRole[] = [
  {
    ...
    bullets: [
      "Built and shipped Agent Analysis, an LLM-powered call-analysis workflow: managers evaluate call performance with configurable categories, filtered sampling and actionable insights.",
      "Led a Flask → FastAPI migration that cut p95 latency ~25–30% on the migrated endpoints.",
      "Standardised post-call CSAT surveys into one configurable pipeline.",
      "Worked across the stack: FastAPI, Python, SQLAlchemy and PostgreSQL on the back; Next.js, React and TanStack Query on the front; Datadog for observability.",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Modernised a React/Flask component architecture, lifting team dev velocity ~30%.",
      "Drove an incremental JS → TypeScript migration, cutting runtime errors ~40% on converted modules.",
      "Onboarded new engineers and gathered requirements directly with clients in a consultancy setting.",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Rewrote the core app from Ruby on Rails to Next.js: +50% performance and −30% server response time.",
      "Built the company’s first documentation system, cutting onboarding from 1.5 weeks to 2 days (−81%).",
      "Made code reviews mandatory: +30% code quality and −20% production issues.",
      "Led ‘GWI Opportunity Exchange’, a community marketplace that lifted engagement +15% in six months.",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Promoted to lead a £9.4M fintech project, cutting development time ~20%.",
      ...
      "Built custom dashboards for financial firms, lifting client engagement +35%.",
    ],
