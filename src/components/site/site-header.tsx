    ...
    <header className="sticky top-0 z-50 border-b border-line bg-paper/80 backdrop-blur-[12px] supports-[backdrop-filter]:bg-paper/70">
      <div className="mx-auto flex max-w-[1200px] flex-wrap items-center justify-between gap-x-5 gap-y-2.5 px-5 py-3 sm:px-7">
        <div className="flex shrink-0 items-center gap-[11px]">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-[15px] font-bold tracking-[-0.02em] text-paper-on-dark [font-family:var(--font-display)]">
            {identity.monogram}
          </div>
          <div className="leading-[1.05]">
            <div className="[font-family:var(--font-display)] text-[16px] font-bold tracking-[-0.01em] text-ink">
              {identity.name}
            </div>
